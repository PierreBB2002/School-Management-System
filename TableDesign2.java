...
public class TableDesign2{
    ...
    public TableDesign2(String[][] res, String[] lab, String table) {
        super();
        this.res = res;
        this.lab = lab;
        this.table = table;
...
//            Image image = new Image(new FileInputStream("C:\\Users\\Lenovo\\Desktop\\SchoolMan2\\src\\application\\.png"));
