...
public class TablePopulate {
    ...
    public TablePopulate(String[][] res, String[] lab, String table) {
        super();
        this.res = res;
        this.lab = lab;
        this.table = table;
    ...
    private class ButtonCell extends TableCell<ObservableList<String>, Boolean> {
        ...
        ButtonCell() {
            ...
            Image image = null;
            try {
                image = new Image(new FileInputStream("C:\\Users\\Lenovo\\Desktop\\SchoolMan2\\src\\application\\delete.png"));
